...
public class MemberDAO {
	...
	public List<MemberDTO> selectAll(MemberDTO boardDTO){
	...
	class BoardRowMapper implements RowMapper<MemberDTO>{
	...
	// 가장 최근 게시물
	class MaxRowMapper implements RowMapper<MemberDTO>{
	...
	// 게시글 번호와 폴더명 반환
	class FolderRowMapper implements RowMapper<MemberDTO>{
