...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="mainPage.do"
			style="font-family: 'Nanum Pen Script', cursive;"> <img
			src="${path}/resources/assets/images/logo.png" alt="Logo"
			style="width: 40px; height: auto;"> 갈빵질빵
		</a>

		<!-- 네비게이션 메뉴 -->
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link" href="mainPage.do">메인화면</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="searchStore.do">붕어빵찾기</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="listProduct.do">MD상품</a>
				</li>
				...
				<c:choose>
					<c:when test="${empty memberPK}">
						...
						<li class="nav-item"><img
							src="${path}/resources/assets/images/default_profile.png"
							class="rounded-circle" style="width: 40px; height: 40px;"
							alt="Default Profile"></li>
					</c:when>
					<c:otherwise>
						<li class="nav-item"><img src="${profileImageUrl}"
							class="rounded-circle" style="width: 40px; height: 40px;"
...
<div id="sidebar" class="bg-light border-right"
	...
	<div
		...
		<a class="navbar-brand d-flex align-items-center" href="mainPage.do"
			style="font-family: 'Nanum Pen Script', cursive;"> <img
			src="${path}/resources/assets/images/logo.png" alt="Logo"
			style="width: 40px; height: auto; margin-right: 10px;"> 갈빵질빵
		</a>
		<!-- 사이드바 닫기 버튼 -->
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link"
			href="listBoards.do?boardCateName=normal">게시판</a></li>
		<c:choose>
			<c:when test="${empty memberPK}">
				<li class="nav-item"><a class="nav-link" href="signupPage.do">회원가입</a>
				</li>
