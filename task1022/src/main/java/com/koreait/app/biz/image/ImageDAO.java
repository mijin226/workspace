...
//		   FOREIGN KEY (BID) REFERENCES BOARD(BID));
	private final String INSERT = "INSERT INTO IMAGE(PATH, BID) \r\n"
			+ "VALUES (?, (SELECT MAX(BID) FROM BOARD))";
	private final String SELECTONE = "SELECT PATH FROM IMAGE WHERE BID=?";
	...
	public ImageDTO selectOne(ImageDTO imageDTO) {
		System.out.println("selectOne ImageDTO start ImageDTO BID : " + imageDTO.getBoardID());
	...
	public boolean insert(ImageDTO imageDTO) {
		System.err.println(" ImageDTO INSERT start :" + imageDTO.toString());
