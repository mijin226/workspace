...
<div style="display: flex; flex-direction: column; gap: 10px; text-align: center;">
    <a href="myBoardList.do" class="btn btn-light" role="button" id="my-write-board">작성한 게시글</a>
    <a href="포인트 구매내역.do" class="btn btn-light" role="button">포인트 구매내역</a>
    <a href="포인트 결제내역.do" class="btn btn-light" role="button">포인트 결제내역</a>
</div>
