			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<%--@declare id="username"--%><label for="username">이름</label> 
						<input type="text" class="form-control" id="memberNickname" name="memberNickname" required placeholder="이름을 입력해주세요">
					</div>
